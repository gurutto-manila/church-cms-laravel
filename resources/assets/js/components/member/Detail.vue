                    ...
                    <div class="flex flex-col lg:flex-row md:flex-row py-3">
                        ...
                        <div class="w-full lg:w-4/5 md:w-4/5 px-3 lg:px-0 md:px-0">
                            ...
                            <div class="pt-3 border-t">
                                <a :href="this.url+'/admin/member/show/'+this.membername" class="text-blue-500 text-sm flex items-center">
...
<script>
    ...
    export default {
        ...
        { 
            ...
            getData()
            {
                axios.get('/admin/member/show/details/'+this.membername).then(response => {
