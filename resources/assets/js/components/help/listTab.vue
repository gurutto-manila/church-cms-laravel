<template>
    <div>
        <ul class="list-reset flex text-xs profile-tab flex-wrap">
            ...
            <li class="px-2 mx-1 py-1" v-bind:class="[{'active' : status === 'reject'}]">
                <a href="#" class="text-gray-700 font-medium" @click="setTab('reject')">Rejected</a>
            </li>

            <li class="px-2 mx-1 py-1" v-bind:class="[{'active' : status === 'close'}]">
                <a href="#" class="text-gray-700 font-medium" @click="setTab('close')">Closed</a>
            </li>
        </ul>
