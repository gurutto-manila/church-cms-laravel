            ...
            <div class="hide-menu" id="show-filter">
                <div class="absolute bg-white w-full  lg:w-2/4  shadow-lg border border-r-0 z-40  h-auto py-3 lg:px-4 overflow-auto search_user_filter">  
                                        ...
                                        <div class="advanced_search_option_container my-2 lg:my-1 md:my-1 flex w-full lg:w-3/5 md:w-3/5" id="age">   
                                            <div class="w-5/12">
                                                <select name="min_age" v-model="min_age" id="min_age" class="filter-form-control" data-type="dropdown">
                                                    ...
                                                    <option value="" v-for="n in count" v-bind:value="n">{{n}}</option>
                                                </select>
                                            </div>   
                                ...
                                <li id="filter-content-email" class="filter_container hide flex">
                                    ...
                                    <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                                        ...
                                        <div class="advanced_search_option_container my-1 w-full  lg:w-3/5 md:w-3/5" id="location">
                                            <input class="filter-form-control my-2 lg:my-0 md:my-0" name="location" v-model="location" id="location" type="text" value="" placeholder="Location">       
                                        </div>    
                                    </div>   
                                </li>
                    ...
                    <div class="tw-form-row my-4 flex justify-end">
                        ...
                        <a href="#" dusk="search-btn" class="btn btn-submit blue-bg text-white rounded px-3 py-1 ml-3 text-sm font-medium mr-3 md:mr-3 lg:mr-0" @click="searchmember()">Search</a>
                    </div>
                </div>
            </div>
        </portal>
...
<script>
    ...
    export default {
        ...
        methods:
        {
            getData()
            {
                axios.get('/admin/subadmin/filter/list').then(response => {
            ...
            searchmember()
            {
                ...
                this.final=this.url+'/admin/subadmins/?'+this.searchquery;
