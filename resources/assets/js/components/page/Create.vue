<template>
    <div class="bg-white shadow px-4 py-3 my-3">
        ...
        <div class="flex flex-col lg:flex-row w-full">
            <div class="tw-form-group w-full lg:w-3/4">
                <div class="lg:mr-4 md:mr-4 px-2">
                    <div class="mb-2">
            ...
            <div class="py-3 lg:py-10 md:py-3 p-2">
                    ...
                    <div class="modal-body">
                        <div class="flex flex-col">
                            <div class="w-full lg:w-1/4"> 
                                <label for="name" class="tw-form-label">Category Name<span class="text-red-500">*</span></label>
                            </div>
    ...
    export default {
        ...
        methods:
        {
            ...
            addCategory()
            {
                ...
                axios.post(this.url+'/'+this.mode+'/pageCategory/add',formData,{headers: {'Content-Type': 'multipart/form-data'}}).then(response => {     
            ...
            submitForm()
            {
                ...
                axios.post(this.url+'/'+this.mode+'/page/add',formData,{headers: {'Content-Type': 'multipart/form-data'}}).then(response => {     
                    this.success = response.data.success;
                    this.resetForm();
                }).catch(error => {
                    this.errors = error.response.data.errors;
