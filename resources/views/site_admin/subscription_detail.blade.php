    ...
    <div class="w-1/2 lg:mr-8 md:mr-8">
        <table class="w-full">
            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Merchant Key : </td>
                <td class="py-3 px-2">{{ $subscriptions->payment_details['merchant_key'] }} </td>
            </tr>
            <tr class="border-t-2 border-b-2">
            ...
            <tr class="border-t-2 border-b-2">
                <td class="py-3 px-2">Hash : </td>
                <td class="py-3 px-2">{{ $subscriptions->payment_details['hash'] }} </td>
            </tr>
            <tr class="border-t-2 border-b-2">
