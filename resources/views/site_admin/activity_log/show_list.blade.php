    ...
    <table class="table table-hover w-full border">
        ...
        <tbody>
            @foreach ($activitylog as $activity)
                <tr>
                    <td> <a href="{{ url('admin/activity_log/' . optional($activity->user)->name) }}">{{ optional($activity->user)->name }}
                    </td>
                    ...
                    <!-- <td><a href="{{ url('admin/activity/' . $activity->id) }}" class="no-underline text-black mr-2 border rounded p-1"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
