    ...
    <div class="w-full">
        <div>
            <h1 class="admin-h1 mb-5 flex items-center">
                ...
                <span class="mx-3">Edit Widgets</span>
            </h1>
        </div>
        <div class="bg-white shadow my-5">

            <div class="px-3 py-3 mx-2">
                <form method="post" action="{{ url('/admin/widgets/' . $editInfo->id . '/update') }}" id="widgets"
                    ...
                    <div class="mt-6 mb-4">
                        <button class="btn btn-primary blue-bg text-white rounded px-3 py-1 text-xs font-medium"
