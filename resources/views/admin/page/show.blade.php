...
@section('content')
    ...
    <div class="">
        <h1 class="admin-h1 flex items-center">
            <a href="{{ url('/admin/pages') }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <show-page url="{{ url('/') }}" id="{{ $page->id }}" entity_id="{{ $entity_id }}"
            entity_name="{{ $entity_name }}" mode="admin"></show-page>
        <page-tab url="{{ url('/') }}" id="{{ $page->id }}" entity_id="{{ $entity_id }}"
            entity_name="{{ $entity_name }}" mode="admin"></page-tab>
