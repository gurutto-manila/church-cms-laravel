...
@section('content')
    ...
    <div class="">
        <h1 class="admin-h1 flex items-center">
            <a href="{{ url('/admin/posts') }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <edit-post url="{{ url('/') }}" id="{{ $post->id }}" entity_id="{{ $entity_id }}"
            entity_name="{{ $entity_name }}" mode="admin"></edit-post>
    </div>
