...
@section('content')
    ...
    <div class="">
        <!--<h1 class="admin-h1 my-3 flex items-center">
          <a href="{{ url('/admin/campaign/show/' . $campaign_id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
          ...
          <span class="mx-3">Attach Campaign</span>
        </h1> -->
        @include('partials.message')
        <test-mail mode="admin" campaign_id="{{ $campaign_id }}"></test-mail>
    </div>
@endsection
