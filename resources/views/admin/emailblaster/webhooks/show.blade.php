...
@section('content')
    <div class="flex items-center justify-between">
        <h1 class="admin-h1 flex items-center">
            ...
            <span class="mx-3">Webhook Details</span>
        </h1>
    </div>
            ...
            <div class="w-full lg:mr-8 md:mr-8 custom-table">
                <table class="w-full">
                    ...
                    <tr class="border-t border-b">
                        ...
                        <td class="py-3 px-2">
                            <a
                                href="{{ url('/admin/mailinglist/show/' . $webhook->mailinglist_id) }}">{{ $webhook->mailinglist->name }}</a>
                        </td>
                    </tr>
                    <tr class="border-t border-b">
                        <td class="py-3 px-2 font-semibold">URL</td>
                        <td class="py-3 px-2">{{ $webhook->url }}</td>
                    </tr>
                    <tr class="border-t border-b">
                        <td class="py-3 px-2 font-semibold">Handshake Key</td>
                        <td class="py-3 px-2">{{ $webhook->handshake_key }}</td>
                    </tr>
                    <tr class="border-t border-b">
