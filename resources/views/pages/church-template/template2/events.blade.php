    ...
    <div class="app ">
        ...
        <div class="relative">
            <div class="event-section">
                <div>
                    <h2 class="text-3xl font-bold uppercase text-white absolute bottom-0 text-center w-full mb-24">Events
                    </h2>
      ...
      <li><a href="donation.html" class="px-3 py-2 mx-2 lg:mx-3 md:mx-3 text-black">Charity & Donation</a></li> -->
        ...
        <div class="my-5">
            <div class="container mx-auto">
                <div class="py-5 px-3 lg:px-0 md:px-0">
                    <h1 class="custom-txt uppercase text-2xl py-4">Upcoming Events</h1>
                    <!-- ** -->
                    <div class="flex flex-col lg:flex-row md:flex-row w-full  my-4 shadow">
                        <div class="w-full lg:w-3/5 flex py-4">
      ...
      L224.085,282.783z" />
                        ...
                        <div class="custom-bg w-full lg:w-2/5">
                            <div class="text-white flex items-center justify-center h-full">
                                <ul class="list-reset flex items-center justify-center w-full">
                ...
                <div class="lg:py-5 md:py-5">
                    <div class="w-full p-3 lg:px-0 md:px-0">
                        <h2 class="custom-txt uppercase text-2xl py-4">Latest Events</h2>
                        <!-- ** -->
                        <div class="flex flex-col lg:flex-row md:flex-row w-full py-4 my-4">
                            <div class="flex">
                                <div class="custom-bg w-24 h-24 text-center flex flex-col p-2" data-aos="zoom-in"
                                    ...
                                    <h2 class="text-3xl md:text-2xl lg:text-3xl font-medium italic text-white border-b">
                                        22nd</h2>
                                    <p class="text-base mb-0 text-white opacity-50 mt-1">Nov, 2020</p>
                                </div>
                                <div class="w-8/12">
                                    <img src="{{ url('church-template/template1/prayer.jpg') }}" class="w-56 h-40"
                                        alt="prayer">
                                </div>
                            </div>
                            <div
                                class="w-full lg:w-2/3 lg:px-3 md:px-3 flex flex-col lg:flex-row md:flex-row  items-center justify-between">
                                <div>
                                    <h2 class="text-xl lg:text-2xl font-medium text-gray-800">Sharing Our Faith & Love
                                        To Children</h2>
                                    <!-- start -->
                                    <div class="flex items-center py-2">
                                        <svg class="w-5 h-5 fill-current custom-txt" version="1.1" id="Capa_1"
      ...
      L224.085,282.783z" />
                                ...
                                <div class="mt-2">
                                    <a href="#" class="text-sm read-more px-2 py-2 custom-txt">Read more </a>
                                </div>
                            </div>
                        </div>
                        <!-- ** -->
                        ...
                        <div class="flex flex-col lg:flex-row md:flex-row w-full py-4 my-4">
                            <div class="flex">
                                ...
                                <div class="w-8/12">
                                    <img src="{{ url('church-template/template1/event1.jpg') }}" class="w-56 h-40"
                                        alt="Know jesus christ better through lines">
                                </div>
                            </div>
                            <div
                                class="w-full lg:w-2/3 lg:px-3 md:px-3 flex flex-col lg:flex-row md:flex-row  items-center justify-between">
                                <div>
                                    <h2 class="text-xl lg:text-2xl font-medium text-gray-800">Know Jesus Christ Better
                                        Through Lines</h2>
                                    <!-- start -->
                                    <div class="flex items-center py-2">
                                        <svg class="w-5 h-5 fill-current custom-txt" version="1.1" id="Capa_1"
      ...
      c-9.154,0-16.577,7.417-16.577,16.573v96.805C344.458,122.533,351.881,129.945,361.035,129.945z" />
                                        ...
                                        <span class="italic mx-2 text-gray-500">Friday 10.00 Am - Friday 11.00
                                            Am</span>
                                    </div>
                                    <!-- end -->
                                    <!-- start -->
                        ...
                        <div class="flex flex-col lg:flex-row md:flex-row w-full py-4 my-4">
                            <div class="flex">
                                <div class="custom-bg w-24 h-24 text-center flex flex-col p-2" data-aos="zoom-in"
                                    data-aos-duration="3000">
                                    <h2
                                        class="text-3xl md:text-2xl lg:text-3xl font-medium italic text-white border-b">
                                        22nd</h2>
                                    <p class="text-base mb-0 text-white opacity-50 mt-1">Nov, 2020</p>
                                </div>
                                <div class="w-8/12">
                                    <img src="{{ url('church-template/template1/prayer.jpg') }}"
                                        class="w-56 h-40" alt="Caring about the community & serving">
                                </div>
                            </div>
                            <div
                                class="w-full lg:w-2/3 lg:px-3 md:px-3 flex flex-col lg:flex-row md:flex-row items-center justify-between">
                                <div>
                                    <h2 class="text-xl lg:text-2xl font-medium text-gray-800">Caring About The
                                        Community & Serving</h2>
                                    <!-- start -->
                                    <div class="flex items-center py-2">
                                        <svg class="w-5 h-5 fill-current custom-txt" version="1.1" id="Capa_1"
                                            xmlns="http://www.w3.org/2000/svg"
      ...
      c-9.154,0-16.577,7.417-16.577,16.573v96.805C344.458,122.533,351.881,129.945,361.035,129.945z" />
                                        ...
                                        <span class="italic mx-2 text-gray-500">Monday 01.00 Pm - Monday 02.30
                                            pm</span>
                                    </div>
                                    <!-- end -->
                                    <!-- start -->
