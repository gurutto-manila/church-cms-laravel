...
<body class="overflow-x-hidden">
    <div class="app relative">
        ...
        <div class="my-5">
            <div class="container mx-auto">
                <div class="lg:py-5 md:py-5">
                    <div class="w-full">
                        <!-- ** -->
                        <div class="flex flex-col lg:flex-row md:flex-row w-full lg:py-4 md:py-4 my-4">
                            ...
                            <div class="w-full lg:w-4/5 md:w-4/5 lg:px-3 md:px-3 py-2 lg:py-0 md:py-0">
                                <div>
      ...
      c-9.154,0-16.577,7.417-16.577,16.573v96.805C344.458,122.533,351.881,129.945,361.035,129.945z" />
                                        ...
                                        <span class="italic mx-2 text-gray-500">22th Nov 2020, Tuesday 8.00 Am - 10.00
                                            Am</span>
                                    </div>
                                    <!-- end -->
      ...
      c-9.154,0-16.577,7.417-16.577,16.573v96.805C344.458,122.533,351.881,129.945,361.035,129.945z" />
                                        ...
                                        <span class="italic mx-2 text-gray-500">23th Nov 2020, Wednesday 8.00 Am - 10.00
                                            Am</span>
                                    </div>
                                    <!-- end -->
      ...
      c-9.154,0-16.577,7.417-16.577,16.573v96.805C344.458,122.533,351.881,129.945,361.035,129.945z" />
                                        ...
                                        <span class="italic mx-2 text-gray-500">24th Nov 2020, Thursday 8.00 Am - 10.00
                                            Am</span>
                                    </div>
                                    <!-- end -->
                                    <!-- start -->
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full">
                            <form>
                                ...
                                <div
                                    class="mb-4 mt-2 donate-btn py-2 text-center w-1/2 lg:w-1/6 md:w-1/6 rounded mx-2 custom-bg">
                                    <a href="#" class="uppercase  text-white ">Submit</a>
                                </div>
                            </form>
                        </div>
