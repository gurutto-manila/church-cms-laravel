        ...
        <div class="custom-bg">
            <div class="container py-4">
                <div class="flex items-center justify-between">
                    <h2 class="capitalize text-xl lg:text-3xl md:text-2xl font-semibold text-white mb-0">Video Gallery
                    </h2>
                    <ul class="list-reset text-base flex items-center text-white mb-0">
                        <li><a href="#" class="text-white font-semibold">Home</a></li>
                        <li class="mx-2">/</li>
                        <li class="opacity-50"> Video Gallery </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="page-head">
                <div class="demo-gallery">
                    <ul id="lightgallery" class="flex flex-wrap">
                        ...
                        <li class="video" data-src="https://www.youtube.com/watch?v=Pq9yPrLWMyU"
                            data-poster="{{ url('church-template/template1/ministry-img.jpg') }}">
                            <a href="">
                                <img class="img-responsive"
                                    src="{{ url('church-template/template1/ministry-img.jpg') }}" alt="video gallery">
                                <div class="demo-gallery-poster">
                                    <img src="{{ url('church-template/template1/play-button.svg') }}"
                                        alt="play button">
                                </div>
